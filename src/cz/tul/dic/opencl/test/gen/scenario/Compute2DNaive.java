 ...
 * @author Petr Jecmen
 */
public class Compute2DNaive extends Scenario2D {

    private static final String NAME = "Compute2DNaive";

    public Compute2DNaive(final ContextHandler contextHandler) throws IOException {
