package cz.tul.dic.opencl.test.gen.scenario.limits.d2.opt;
...
import cz.tul.dic.opencl.test.gen.scenario.limits.d2.Scenario2D;
 ...
 * @author Petr Jecmen
 */
public class CL_L_2DImageV extends Scenario2D {
