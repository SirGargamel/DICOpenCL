 ...
 * @author Petr Jecmen
 */
public class Compute15DIntPerFacet extends Scenario15D {

    private static final String KERNEL_NAME = "Compute15DIntPerFacet";

    public Compute15DIntPerFacet(final ContextHandler contextHandler) throws IOException {
