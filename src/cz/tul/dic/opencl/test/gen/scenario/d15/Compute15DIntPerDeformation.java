 ...
 * @author Petr Jecmen
 */
public class Compute15DIntPerDeformation extends Scenario15D {

    private static final String KERNEL_NAME = "Compute15DIntPerDeformation";

    public Compute15DIntPerDeformation(final ContextHandler contextHandler) throws IOException {
    ...
    public ScenarioResult computeScenario(
        ...
        final CLBuffer<IntBuffer> bufferDeformationIndex = context.createIntBuffer(1, READ_ONLY);
