package cz.tul.dic.test.opencl.test.gen.scenario.limitsD.d1.opt;
 ...
 * @author Petr Jecmen
 */
public final class CL_LD_1DImageLL extends ScenarioOpenCL_LD {

    private int maxVariantCount, lws0base, lws0base2;
    private int currentVariant;
    private boolean inited;

    public CL_LD_1DImageLL(final ContextHandler contextHandler) throws IOException {
    ...
    public float[] prepareAndCompute(
        ...
        float[] result = null;
        try {
            result = computeScenario(imageA, imageB, facetData, facetCenters, deformationLimits, deformationCounts, params);
    ...
    float[] computeScenario(
        ...
        kernel.putArgs(imageAcl, imageBcl, bufferFacetData, bufferFacetCenters, bufferDeformations, bufferDeformationCounts, bufferResult)
