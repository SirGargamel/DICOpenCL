package cz.tul.dic.test.opencl.test.gen.scenario.limitsNO.d2;
 ...
 * @author Petr Jecmen
 */
public abstract class Scenario2D_NO extends ScenarioOpenCL_NO {
    ...
    public Scenario2D_NO(final ContextHandler contextHandler) throws IOException {
