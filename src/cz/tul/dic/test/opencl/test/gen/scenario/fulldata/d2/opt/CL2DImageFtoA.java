package cz.tul.dic.test.opencl.test.gen.scenario.fulldata.d2.opt;
 ...
 * @author Petr Jecmen
 */
public class CL2DImageFtoA extends Scenario2D {

    public CL2DImageFtoA(final ContextHandler contextHandler) throws IOException {
