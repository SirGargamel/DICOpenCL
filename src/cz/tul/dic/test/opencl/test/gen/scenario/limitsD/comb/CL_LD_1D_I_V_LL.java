package cz.tul.dic.test.opencl.test.gen.scenario.limitsD.comb;
 ...
 * @author Petr Jecmen
 */
public final class CL_LD_1D_I_V_LL extends ScenarioOpenCL_LD {

    private int maxVariantCount, lws0base, lws0base2;
    private int currentVariant;
    private boolean inited;

    public CL_LD_1D_I_V_LL(final ContextHandler contextHandler) throws IOException {
