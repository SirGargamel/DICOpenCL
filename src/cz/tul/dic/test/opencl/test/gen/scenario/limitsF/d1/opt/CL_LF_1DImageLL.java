package cz.tul.dic.test.opencl.test.gen.scenario.limitsF.d1.opt;
 ...
 * @author Petr Jecmen
 */
public final class CL_LF_1DImageLL extends ScenarioOpenCL_LF {

    private int maxVariantCount, lws0base, lws0base2;
    private int currentVariant;
    private boolean inited;

    public CL_LF_1DImageLL(final ContextHandler contextHandler) throws IOException {
