package cz.tul.dic.test.opencl.test.gen.scenario.limitsD.d2.opt;
...
import cz.tul.dic.test.opencl.test.gen.scenario.limitsD.d2.Scenario2D_LD;
 ...
 * @author Petr Jecmen
 */
public class CL_LD_2DImageV extends Scenario2D_LD {

    public CL_LD_2DImageV(final ContextHandler contextHandler) throws IOException {
