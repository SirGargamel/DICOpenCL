package cz.tul.dic.test.opencl.test.gen.scenario.limitsD.d2;
 ...
 * @author Petr Jecmen
 */
public class CL_LD_2DInt extends Scenario2D_LD {

    private final String kernelName;

    public CL_LD_2DInt(final String kernelName, final ContextHandler contextHandler) throws IOException {
    ...
    public float[] computeScenario(
        ...
        final long clSize = bufferImageA.getCLSize() + bufferImageB.getCLSize() + bufferFacetData.getCLSize() + bufferDeformations.getCLSize() + bufferDeformationCounts.getCLSize() + bufferResult.getCLSize();
        params.addParameter(Parameter.DATASIZE, (int) (clSize / 1000));
        // prepare kernel arguments        
        final CLKernel kernel = contextHandler.getKernel();
        kernel.putArgs(bufferImageA, bufferImageB, bufferFacetData, bufferFacetCenters, bufferDeformations, bufferDeformationCounts, bufferResult)
