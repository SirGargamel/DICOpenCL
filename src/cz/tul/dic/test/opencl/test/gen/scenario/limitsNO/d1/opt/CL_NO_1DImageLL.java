package cz.tul.dic.test.opencl.test.gen.scenario.limitsNO.d1.opt;
 ...
 * @author Petr Jecmen
 */
public final class CL_NO_1DImageLL extends ScenarioOpenCL_NO {

    private int maxVariantCount, lws0base, lws0base2;
    private int currentVariant;
    private boolean inited;

    public CL_NO_1DImageLL(final ContextHandler contextHandler) throws IOException {
