 ...
 * @author Petr Jecmen
 */
public class CL2D_I_V_D extends ScenarioDrivenOpenCL {
    
    private static final int ARGUMENT_INDEX = 11;
    private static final int OPTIMAL_LWS1 = 128;

    public CL2D_I_V_D(final ContextHandler contextHandler, final WorkSizeManager wsm) throws IOException {
