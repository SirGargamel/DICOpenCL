package cz.tul.dic.test.opencl.test.gen.scenario.fulldata.driven;
 ...
 * @author Petr Jecmen
 */
public final class CL1D_I_V_LL_MC_D extends ScenarioDrivenOpenCL {

    private static final int ARGUMENT_INDEX = 12;    
    private int lws0base;
    private boolean inited;

    public CL1D_I_V_LL_MC_D(final ContextHandler contextHandler, final WorkSizeManager wsm) throws IOException {
