package cz.tul.dic.test.opencl.test.gen.scenario.limitsNO.d2.opt;
...
import cz.tul.dic.test.opencl.test.gen.scenario.limitsNO.d2.Scenario2D_NO;
 ...
 * @author Petr Jecmen
 */
public class CL_NO_2DImageV extends Scenario2D_NO {

    public CL_NO_2DImageV(final ContextHandler contextHandler) throws IOException {
