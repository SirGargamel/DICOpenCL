 ...
 * @author Petr Jecmen
 */
public abstract class ScenarioOpenCL_LF_GPU extends ScenarioLimitsF_GPU {
    ...
    public ScenarioOpenCL_LF_GPU(ContextHandler contextHandler) throws IOException {
        super();
    ...
    public ScenarioResult compute(
        ...
        float[] result = prepareAndCompute(imageA, imageB, facetCenters, bufferDeformations, params);
