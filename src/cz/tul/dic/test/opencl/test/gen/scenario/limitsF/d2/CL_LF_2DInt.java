package cz.tul.dic.test.opencl.test.gen.scenario.limitsF.d2;
 ...
 * @author Petr Jecmen
 */
public class CL_LF_2DInt extends Scenario2D_LF {

    private final String kernelName;

    public CL_LF_2DInt(final String kernelName, final ContextHandler contextHandler) throws IOException {
