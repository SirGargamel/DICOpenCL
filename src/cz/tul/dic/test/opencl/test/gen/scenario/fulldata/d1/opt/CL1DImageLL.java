package cz.tul.dic.test.opencl.test.gen.scenario.fulldata.d1.opt;
 ...
 * @author Petr Jecmen
 */
public final class CL1DImageLL extends ScenarioOpenCL {

    private int maxVariantCount, lws0base, lws0base2;
    private int currentVariant;
    private boolean inited;

    public CL1DImageLL(final ContextHandler contextHandler) throws IOException {
