...
import cz.tul.dic.test.opencl.test.gen.scenario.fulldata.d2.Scenario2D;
 ...
 * @author Petr Jecmen
 */
public class CL2D_I_V_MC extends Scenario2D {

    public CL2D_I_V_MC(final ContextHandler contextHandler) throws IOException {
