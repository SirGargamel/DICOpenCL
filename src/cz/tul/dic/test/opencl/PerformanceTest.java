...
import cz.tul.dic.test.opencl.test.gen.Utils;
import cz.tul.dic.test.opencl.test.gen.WorkSizeManager;
...
import cz.tul.dic.test.opencl.test.gen.scenario.fulldata.driven.CL1D_I_V_LL_D;
import cz.tul.dic.test.opencl.test.gen.scenario.fulldata.driven.CL1D_I_V_LL_MC_D;
import cz.tul.dic.test.opencl.test.gen.scenario.fulldata.driven.CL2D_I_D;
import cz.tul.dic.test.opencl.test.gen.scenario.fulldata.driven.CL2D_I_V_D;
import cz.tul.dic.test.opencl.test.gen.scenario.fulldata.driven.CL2D_I_V_MC_D;
import cz.tul.dic.test.opencl.test.gen.scenario.fulldata.driven.CL2D_Int_D;
import cz.tul.dic.test.opencl.test.gen.scenario.fulldata.Scenario;
import cz.tul.dic.test.opencl.test.gen.scenario.fulldata.ScenarioDrivenOpenCL;
import cz.tul.dic.test.opencl.test.gen.scenario.fulldata.ScenarioOpenCL;
import cz.tul.dic.test.opencl.test.gen.scenario.fulldata.comb.CL1D_I_LL_MC;
import cz.tul.dic.test.opencl.test.gen.scenario.fulldata.comb.CL1D_I_V_LL;
import cz.tul.dic.test.opencl.test.gen.scenario.fulldata.comb.CL1D_I_V_LL_MC;
import cz.tul.dic.test.opencl.test.gen.scenario.fulldata.comb.CL2D_I_V_MC;
import cz.tul.dic.test.opencl.test.gen.scenario.fulldata.d1.CL1DIntPerDeformationSingle;
import cz.tul.dic.test.opencl.test.gen.scenario.fulldata.d1.CL1DIntPerFacetSingle;
import cz.tul.dic.test.opencl.test.gen.scenario.fulldata.d1.opt.CL1DImageL;
import cz.tul.dic.test.opencl.test.gen.scenario.fulldata.d1.opt.CL1DImageLL;
import cz.tul.dic.test.opencl.test.gen.scenario.fulldata.d15.CL15DIntPerDeformation;
import cz.tul.dic.test.opencl.test.gen.scenario.fulldata.d15.CL15DIntPerFacet;
import cz.tul.dic.test.opencl.test.gen.scenario.fulldata.d2.CL2DImage;
import cz.tul.dic.test.opencl.test.gen.scenario.fulldata.d2.CL2DInt;
import cz.tul.dic.test.opencl.test.gen.scenario.fulldata.d2.opt.CL2DImageC;
import cz.tul.dic.test.opencl.test.gen.scenario.fulldata.d2.opt.CL2DImageFtoA;
import cz.tul.dic.test.opencl.test.gen.scenario.fulldata.d2.opt.CL2DImageMC;
...
import cz.tul.dic.test.opencl.test.gen.scenario.limitsD.comb.CL_LD_1D_I_V_LL;
import cz.tul.dic.test.opencl.test.gen.scenario.limitsD.d1.opt.CL_LD_1DImageLL;
import cz.tul.dic.test.opencl.test.gen.scenario.limitsD.d2.CL_LD_2DImage;
import cz.tul.dic.test.opencl.test.gen.scenario.limitsD.d2.CL_LD_2DInt;
import cz.tul.dic.test.opencl.test.gen.scenario.limitsD.d2.opt.CL_LD_2DImageV;
...
import cz.tul.dic.test.opencl.test.gen.scenario.limitsF.comb.CL_LF_1D_I_V_LL;
import cz.tul.dic.test.opencl.test.gen.scenario.limitsF.d1.opt.CL_LF_1DImageLL;
import cz.tul.dic.test.opencl.test.gen.scenario.limitsF.d2.CL_LF_2DImage;
import cz.tul.dic.test.opencl.test.gen.scenario.limitsF.d2.CL_LF_2DInt;
import cz.tul.dic.test.opencl.test.gen.scenario.limitsF.d2.opt.CL_LF_2DImageV;
...
import cz.tul.dic.test.opencl.test.gen.scenario.limitsFD.comb.CL_L_1D_I_V_LL;
import cz.tul.dic.test.opencl.test.gen.scenario.limitsFD.d1.opt.CL_L_1DImageLL;
