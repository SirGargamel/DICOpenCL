...
public class DataStorage {
    ...
    private static int validateResult(final ScenarioResult result, final ParameterSet rps) {
        ...
        for (ParameterSet ps : resultGroups.keySet()) {
            if (ps.equals(rps, Parameter.IMAGE_WIDTH, Parameter.IMAGE_HEIGHT, Parameter.FACET_SIZE, Parameter.FACET_COUNT, Parameter.DEFORMATION_COUNT, Parameter.TEST_CASE)) {
