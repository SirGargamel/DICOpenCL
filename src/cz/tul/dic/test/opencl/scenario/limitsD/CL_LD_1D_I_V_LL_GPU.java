 ...
 * @author Petr Jecmen
 */
public final class CL_LD_1D_I_V_LL_GPU extends ScenarioOpenCL_LD_GPU {

    private int maxVariantCount, lws0base, lws0base2;
    private int currentVariant;
    private boolean inited;

    public CL_LD_1D_I_V_LL_GPU(final ContextHandler contextHandler) throws IOException {
    ...
    public float[] prepareAndCompute(
        ...
        float[] result = null;
        try {
            result = computeScenario(imageA, imageB, bufferFacetData, bufferFacetCenters, deformationLimits, deformationCounts, params);
