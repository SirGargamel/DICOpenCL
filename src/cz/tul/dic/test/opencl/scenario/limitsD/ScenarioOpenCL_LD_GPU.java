 ...
 * @author Petr Jecmen
 */
public abstract class ScenarioOpenCL_LD_GPU extends ScenarioLimitsD_GPU {
    ...
    public ScenarioOpenCL_LD_GPU(ContextHandler contextHandler) throws IOException {
        super();
    ...
    public ScenarioResult compute(
        ...
        float[] result = prepareAndCompute(imageA, imageB, bufferFacetData, bufferFacetCenters, deformationLimits, deformationCounts, params);
