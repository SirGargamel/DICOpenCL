 ...
 * @author Petr Jecmen
 */
public class CL_LD_2DInt_GPU extends Scenario2D_LD_GPU {

    private final String kernelName;

    public CL_LD_2DInt_GPU(final String kernelName, final ContextHandler contextHandler) throws IOException {
