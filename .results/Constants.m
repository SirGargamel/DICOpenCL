...
INDEX_TIME_TOTAL = 11;
INDEX_VARIANT = 6;
NAMES_VARIANTS = {'Threads pF' 'Threads pD' '1D pF' '1D pD' '1.5D pF' '1.5D pD' '2D Naive' '2D Int[]' '2D Image' '2DI FtoA' '2DI MC' '2DI Vec' '2DI V+MC' '2DI LpF' '2DI LpFL' '1DI LpF' '1DI LpF_L'};
TEST_CASE_RANDOM = 1;
TEST_CASE_SHIFT = 2;
TIME_KERNEL = 1;
TIME_TOTAL = 2;
