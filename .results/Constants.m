...
INDEX_TIME_TOTAL = 12;
INDEX_VARIANT = 6;
NAMES_VARIANTS = {'TpF' 'TpD' '1D pF' '1D pD' '1.5D pF' '1.5D pD' '2D Naive' '2D Int[]' '2D I' '2D I FtoA' '2D I MC' '2D I Vec' '2D I C' '1D I L' '1D I LL' '2D I V + MC' '2D I LL + V' '2D I LL + MC'};
TEST_CASE_RANDOM = 1;
TEST_CASE_SHIFT = 2;
TIME_KERNEL = 1;
TIME_TOTAL = 2;
